...
<div class="colorback" style="background-color: #2693ff">
    ...
    <tr>
        <td width="40%" class="contact">
            <img src="images/avatar/franco.jpg"><br>
    ...
    <tr>
        <td width="40%" class="contact">
            ...
            <a href="mailto:hayashis@iu.edu">Soichi Hayashi</a><br>
...
<div>
    ...
    <tr>
        ...
        <td width="60%">
            Lindsey is a Ph.D. candidate at Indiana University. She implemented many of the early brainlife.io Apps as part of her research projects in the Pestilli Laboratory. Lindsey is passionate about Machine-Learning, shape analysis, and 3D-printing technology.
        </td>
    </tr>
    <tr>
        <td width="40%" class="contact">
